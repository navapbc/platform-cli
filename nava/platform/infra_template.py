...
class InfraTemplate:
    ...
    def __init__(self, ctx: CliContext, template_uri: Path | str):
        self.ctx = ctx
    ...
    def install(
        ...
        *,
        ...
        self.template_base.install(project, app_name="base", version=version, data=base_data)
